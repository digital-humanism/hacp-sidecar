...
func TestConformanceRunnerReportsBoundaryCrossingForDataClassViolation(
	t *testing.T,
) {
	...
	const keyID = "data-class-reason-test-key"
	...
	unsignedEnvelope := map[string]any{
		"hacp_version":     "0.9",
		"envelope_id":      "data-class-reason-envelope",
		"principal":        "data-class-reason-system",
		"principal_kind":   "system",
		"intent_statement": "Data class boundary reason-code conformance",
		"scope": map[string]any{
			...
			"data_classes":     []string{"public", "internal"},
		},
	...
	proposedAction := json.RawMessage(`{
                "hacp_version":"0.9",
                "action_id":"data-class-reason-action",
                "envelope_id":"data-class-reason-envelope",
                "verb":"read",
	...
	resp := runner.HandleRequest(Request{
		...
		Operation:       "evaluate",
		VectorID:        "CORE-INV2-007-DATA-CLASS-REASON",
		Input:           input,
	})
