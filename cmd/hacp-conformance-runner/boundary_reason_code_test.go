...
func TestConformanceRunnerReportsBoundaryCrossingForAudienceViolation(
	t *testing.T,
) {
	...
	const keyID = "boundary-reason-test-key"
	...
	unsignedEnvelope := map[string]any{
		"hacp_version":     "0.9",
		"envelope_id":      "boundary-reason-envelope",
		"principal":        "boundary-reason-system",
		"principal_kind":   "system",
		"intent_statement": "Audience boundary reason-code conformance",
	...
	proposedAction := json.RawMessage(`{
		"hacp_version":"0.9",
		"action_id":"boundary-reason-action",
		"envelope_id":"boundary-reason-envelope",
		"verb":"read",
	...
	resp := runner.HandleRequest(Request{
		...
		Operation:       "evaluate",
		VectorID:        "CORE-INV2-002-AUDIENCE-REASON",
		Input:           input,
	})
