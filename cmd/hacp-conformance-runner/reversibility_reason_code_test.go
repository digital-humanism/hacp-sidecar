...
func TestConformanceRunnerReportsBoundaryCrossingForReversibilityViolation(
	t *testing.T,
) {
	...
	const keyID = "reversibility-reason-test-key"
	...
	unsignedEnvelope := map[string]any{
		"hacp_version":     "0.9",
		"envelope_id":      "reversibility-reason-envelope",
		"principal":        "reversibility-reason-system",
		"principal_kind":   "system",
		"intent_statement": "Reversibility boundary reason-code conformance",
		"scope": map[string]any{
			"verbs":            []string{"delete"},
			"resource_classes": []string{"temp_data"},
	...
	proposedAction := json.RawMessage(`{
                "hacp_version":"0.9",
                "action_id":"reversibility-reason-action",
                "envelope_id":"reversibility-reason-envelope",
                "verb":"delete",
                "resource_class":"temp_data",
                "resource_id":"tmp://cache/001",
                "audience":"internal",
	...
	resp := runner.HandleRequest(Request{
		...
		Operation:       "evaluate",
		VectorID:        "CORE-INV2-003-REVERSIBILITY-REASON",
		Input:           input,
	})
